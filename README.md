...
Statistical Analysis: Finally, use the scripts in the /glmResults and /PolynomialResults directory to load the fully processed data and run an linear mixed-effects model to test the experimental hypotheses!
